...
class ProductDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query) {
            $edit = "<a href='".route('product.edit',$query->id)."' class='btn btn-primary'><i class='fas fa-edit fa-fw'></i></a>";
            $delete = "<a href='".route('product.destroy',$query->id)."' class='btn btn-danger delete-item mx-2 '><i class='fas fa-trash fa-fw'></i></a>";
